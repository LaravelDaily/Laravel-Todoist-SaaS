...
@else
    <div class="alert alert-warning">You have reached maximum amount of {{ trans('cruds.project.title') }}.
        Please <a href="{{ route('admin.billing.index') }}">upgrade your plan</a>.</div>
@endcan
<div class="card">
                ...
                <tbody>
                    @foreach($projects as $key => $project)
                        <tr data-entry-id="{{ $project->id }}">
                            ...
                            <td>
                                <span style="display:none">{{ $project->active ?? '' }}</span>
